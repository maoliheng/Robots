...
#ifdef UNIX
    sendRequest(argc - 1, argv + 1, "/usr/Robots2/resource/Robot_Type_III/Robot_IX/Robot_IX.xml");
#endif
#ifdef WIN32
    sendRequest(argc - 1, argv + 1, "C:\\Robots\\resource\\Robot_Type_III\\Robot_IX\\Robot_IX.xml");
#endif
